...
if(isset($_POST['submit'])){
       ...
       $mail->isSMTP();
        ...
        $mail->SMTPAuth=true;
        $mail->SMTPDebug = 3;
       $mail->Username='aartisrivas5@gmail.com';
       $mail->Password='aarti123!@#';
...
<nav id="main-nav">
    <ul>
        ...
        <li class="drop-down">
         ...
         <li class="drop-down">
            ...
            <ul class="submenu">
                <li>
                   <a href="register.php">Important Dates</a>
                </li>
                <li>
                ...
                <li>
                   <a href="register.php">Payment Mode</a>
                </li> 
                <li>
                    <a href="register.php">Fee Structure</a>
                </li>
            </ul>
        </li>
        <li class="drop-down">
            <a href="#">Special Session
                <i class="fas fa-caret-down"></i></a>
            <ul class="submenu">
                <li>
  ...
  <div class="mobile-nav">
    <ul>
      ...
      <li class="m-drop-down"><a href="index.php#">Registration <i class="fas fa-caret-down"></i></a>
        <ul>
        ...
        <li class="m-drop-down"><a href="index.php#">Special Session <i class="fas fa-caret-down"></i></a>
        <ul>
         ...
         <li class="m-drop-down"><a href="index.php#">Portfolio <i class="fas fa-caret-down"></i></a>
        <ul>
         ...
         <li class="m-drop-down"><a href="index.php#">Submission</a>
          ...
          <h3>About Us</h3><hr>
            ...
            <div class="w3-row">
                <div class="w3-container w3-half">
                     <p><center><h5><b>Submission Deadline</b></h5><h4><b>28 th Nov 2019</b></h4> <br>
                     <h5><b>Notification Deadline for Acceptance</b></h5><h4><b>8 th Jan 2020</b></h4> <br>
                     <h5><b>Submission of Accepted Camera Ready Paper</b></h5> <h4><b>6 th Feb 2020</b></h4> <br>
                     <h5><b>Author’s Registration Deadline</b></h5><h4><b>25 th Feb 2020 </b></h4><br>
                     <h5><b>Conference Dates</b></h5><h4><b>18th -19th March 2020</b></h4> <br> </center></p>
                </div>
                <div class="w3-container w3-half">
...
the world; in order to develop and enhance individual knowledge domain. Conference will be
witnessing eminent speakers from across the globe. Research papers from each track after the
      ...
      <div class="container wow fadeInUp w3-border">
        ...
        <div class="jumbotron">
			...
			<div class="card col-md-4" style="width:200px;">
			  <img class="card-img-top" src="img/iet.jpg" alt="p">
			  <div class="card-body">
    ...
    <div class="column">
      <div class="map mb-4 mb-lg-0">
                ...
                <p class="text-center" style="color: #004289;font-family:Open Sans, sans-serif;font-weight:520;">Amity School of Engineering and Technology,<br>
                    Amity University Lucknow Campus,<br>
