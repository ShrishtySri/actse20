...
if(isset($_POST['submit'])){
       ...
       $mail->addAddress('editor.actse@gmail.com');
	...
	echo "<script type='text/javascript'>alert('Message Sent successfully!');</script>"; 
         // echo "<script type='text/javascript'>alert('Something went wrong. Please Try Again.{$mail->ErrorInfo}');</script>";
       }
   } 
...
<head>
  <meta charset="utf-8">
  <title>ACTSE 2020 : International Conference in Amity University 2020 | International Conference in Lucknow 2020 | International Conference in India 2020</title>
  <link rel = "icon"  href="img/company_logo3.jpg" type = "image/x-icon">  
  <meta name="description" content="International Conference on Advances in Computational Technologies in Science and
Engineering (ACTSE-2020), Amity University, Uttar Pradesh, Lucknow Campus is being organized with an objective of bringing together
...
engineers, students, and practitioners."/> 
	
<meta name="keywords" content="International, Conference, Technologies, Science,Engineering, Amity, Lucknow, Research, Peer Review,SCOPUS, Lot Analytics, Deep Learning, MATLAB, iet, csi, iete, Computer, Electronics, Communication, Civil, Aerospace, Mechanical, Automation, Information, Papers, Computational, Registration" /> 
	
  <meta name="keywords" content="Conference ,International Conference, Conference Lucknow, Conference Amity University, Technologies, Science, Engineering, amity, lucknow, research, peer review, SCOPUS,IoT Analytics,  Deep Learning, MATLAB, iet, csi, iete, computer, electronics, Communication, Civil, aerospace, Mechanical, Automation, information, papers, Computational, Registration" />  
...
<header id="header">
    <div class="containerh">
     <div class="logo">
         <img src="img/Amity_University_logo.png" height="80" width="65" alt="no image">
     </div>
     <div class="intro-info">
          
            <h2><b>International Conference on <br>Advances in Computational Technologies in Science and Engineering<br> <span> ACTSE 2020 [18th & 19th March 2020]</span></b></h2>
         </div>    
     <div class="clogo">
         <img src="img/company_logo.jpg" alt="no image">
     </div>    
    </div>
</header> 
...
<nav id="main-nav">
    <ul>
        ...
        <li class="drop-down">
          ...
          <li class="drop-down">
            <a href="register.php">Registration <i class="fas fa-caret-down"></i></a>
	 <ul class="submenu">
		<li>
                   <a href="paper.php">Accepted Papers</a>
                </li>
	</ul>
        </li>
         <li class="drop-down">
    ...
    <ul>
      ...
      <li><a href="register.php">Registration</a>
        ...
        <ul>
         ...
         <li><a href="submission.php">Submission</a>
...
<div id="myModal1" class="modal fade">
    <div class="modal-dialog">
		...
		<p>ACTSE 2020 has been postponed as a preventive measure to combat the Coronavirus (COVID-19), as per guidelines of University Grants Commission (UGC).
<br>Fresh date of conference ACTSE-2020 will be intimated very soon.  </p>
...
<div id="home">
    ...
    <div class="w3-content" style="max-width:1200px">
        <img class="mySlides" src="img/amity1.jpg" style="width:100%" alt="no image">
        <img class="mySlides" src="img/amity2.jpg" style="width:100%" alt="no image">
          ...
          <h3>About Us</h3><hr>
            ...
            <div class="w3-row">
                <div class="w3-container w3-half w3-center">
                     <h5><b>Paper Submission Deadline</b></h5><h4><b>05<sup>th</sup> Mar 2020</b></h4> <br>
                     <h5><b>Notification Deadline for Acceptance</b></h5><h4><b>10<sup>th</sup> Mar 2020</b></h4> <br>
                     <h5><b>Submission of Accepted Camera Ready Paper</b></h5> <h4><b>12<sup>th</sup> Mar 2020</b></h4> <br>
                     <h5><b>Author’s Registration Deadline</b></h5><h4><b>12<sup>th</sup> Mar 2020 </b></h4><br>
                     <h5><b>Conference Dates</b></h5><h4><b>18<sup>th</sup> -19<sup>th</sup> March 2020</b></h4> <br>
                </div>				
                <div class="w3-container w3-half">
                    <p><br><br>
International Conference on Advances in Computational Technologies in Science and Engineering (ACTSE-2020), in Amity University Uttar Pradesh, Lucknow is being organized with an objective of bringing together innovative scientists, professors, research scholars, students and industrial experts in the field of Computing, Applied Science, Aero-space, Mechanical, Civil, Electrical, Electronics and Communication Engineering to a common forum. The primary goal of the conference is to promote the exchange of innovative scientific information between researchers, developers, engineers, students, and practitioners. Another goal is to promote the transformation of fundamental research into institutional and industrialized research and to convert applied exploration into real time application. ACTSE-2020 aims to educate undergraduate students about current and future trends in technology in diversified areas, the event will also provide opportunity to post graduate students and research scholars to interact with experts from across the world; in order to develop and enhance individual knowledge domain. Conference will witness eminent speakers from across the globe. Research papers from each track after the positive blind peer review by at-least two reviewers with good score will be selected for oral presentation during the conference. Extended version of selected papers will be eligible for submission for publication in SCOPUS/ESCI/WoS/UGC Indexed journals/books/proceeding.
</p> 
                </div>
            </div>
     ...
     <div class="container wow fadeInUp w3-border">
        ...
        <div class="w3-row">
                <div class="w3-container w3-center">
                    <h4><b>Pre-Conference complimentary workshop on <br><br><u style="color: #004289;">Next-Generation Communication and IoT Analytics with Deep Learning on MATLAB</u><br> (for registered users) by eminent experts from DesignTech Systems Ltd.</b></h4>
                    
                    <h5 style="color: #004289;"><b>Date of Workshop</b></h5><h4><b>17<sup>th</sup> March 2020</b></h4><br>
                    <h5 style="color: #004289;"><b>Duration</b></h5><h4><b>2:00pm to 4:00 pm</b></h4><br>
                    <h5 style="color: #004289;"><b>Venue</b></h5><h4><b>Lab no. 03, AB1 Building</b></h4><br>
                    <h6><b>Note:- Participants need to give the consent of workshop while registrating for conference.</b></h6><br>
                </div>
        </div>    
    </div>
</section>    
...
<div class="col-md-12 alert alert-info">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="img/Dr Ashok K Chauhan_2.jpg" class="card-img" alt="..." height="250px">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h3 class="card-title"><strong>Patron In Chief</strong><br></h3>
...
<div class="col-md-12 alert alert-info">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="img/Dr. Aseem Chauhan_2.jpg" class="card-img" alt="..." height="250px">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h3 class="card-title"><strong>Patron</strong><br></h3>
...
<div class=" col-md-12 alert alert-info">
  <div class="row ">
    <div class="col-md-4">
      <img src="img/Dr. BALVINDER SHUKLA.jpg" class="card-img" alt="..." height="250px">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h3 class="card-title"><strong>Patron</strong><br></h3>
	<h1>Prof. (Dr.) Balvinder Shukla</h1>
        <p class="text-center">Vice Chancellor, Amity University Uttar Pradesh, Noida, India
...
<div class="col-md-12 alert alert-info" ">
  <div class="row ">
    <div class="col-md-4">
      <img src="img/Dr. Sunil Dhaneshwar.jpg" class="card-img" alt="..." height="250px">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h3 class="card-title"><strong>Co-Patron</strong><br></h3>
	<h1>Prof.(Dr.) Sunil Dhaneshwar</h1>
	<p class="text-center">Pro Vice Chancellor, Amity University Uttar Pradesh, Lucknow Campus
...
<div class="col-md-12 alert alert-info" >
  <div class="row">
    <div class="col-md-4">
      <img src="img/Wg. Cdr. (Dr.) Anil Kumar (Retd)_.jpg" class="card-img" alt="..." height="250px">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h3 class="card-title"><strong>General Chair</strong><br></h3>
        ...
        <div class="card"><!--Start-->
         ...
         <div class="card"><!--Start-->
            ...
            <div class="card-header" id="comNig">
              <h5 class="mb-0 text-center">
                  <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#comcolNig" aria-expanded="true" aria-controls="comcolNig"><b style="font-size:20px">Local Arrangement Chair</b></button>
              </h5>
            </div>
...
<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                      <h6><b>Ms. Shikha Srivastava</b></h6>
                        <p>IBM Multi Cloud Manager Platform Architect, IBM, USA</p>
                    </div>
                  </div>
                  <div class="col-md-4 text-center">
		    <div class="alert alert-dark">
		...
		<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Mr. G.P. Singh</b></h6>
                        <p>Chairman CSI Lucknow </p>
                    </div>
                  </div> 
                    <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
		...
		<div class="col-md-4 text-center">
                  ...
                  <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Jose Antonio Alvarez</b></h6>
                        <p>Air Pollution Researcher,
Institute of Hydraulics and Environmental Sanitation (IHES)  
...
Madrid, Spain</p>
		  ...
		  <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Lamiaa Maher </b></h6>
                        <p>PhD (Environmental Engineering)
Team Leader at PMU/Ministry of Housing, Utilities, Urban Communities
Cairo, Egypt</p>
                    </div>
                  </div>
		 ...
		 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Gaurzv Bajpai </b></h6>
                        <p>College of Science and Technology, University of Rwanda, Africa</p>
                    </div>
                  </div>
 		<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Mohammad Khubeb Siddiqui</b></h6>
                        <p>Post Doctoral Investigator - Data Science, School of Engineering and Sciences, Technologico de Monterrey, Monterrey, Mexico</p>
                    </div>
                  </div>
		 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Vinod Pandey</b></h6>
                        <p>Technical Project Manager, Adasens Automotive GMBH, Germany</p>
                    </div>
                  </div>
                    <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
		 ...
		 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Mr. Satish Kumar</b></h6>
                        <p>Ex CGM BSNL & Chairman IETE Lucknow Centre</p>
                    </div>
                  </div>
                  <div class="col-md-4">
 		...
 		<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Prof. Dr C. GIRI PRASAD</b></h6>
                        <p>DCE,BE,ME,MIGS,MASCE, MDFI,MIHE(London),MBA,Ph.D., Head, Civil Engineering Guntur Engineering College, Guntur, Andhra Pradesh</p>
                    </div>
                  </div>
                    <div class="col-md-4">
                    <div class="alert alert-dark text-center">
 		...
 		<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Neeraj Kumar</b></h6>
                        <p>Profeesor Thapar Institute of Engineering and Technology, Chandigarh</p>
                    </div>
                  </div>
		<div class="col-md-4">
                    <div class="alert alert-dark text-center">
		...
		<div class="col-md-4">
                    <div class="alert alert-dark text-center">
                        <h6><b>Mr. Vishal Berry</b></h6>
                      <p>Group Manager, Oracle India Pvt Ltd.</p>
                    </div>
                  </div>
		<div class="col-md-4">
                    <div class="alert alert-dark text-center">
                        <h6><b>Jai Prakash V. Verma</b></h6>
                      <p>Ph D, Associate Professor, 
Computer Science & Engineering Department,
Institute Of Technology,
Nirma University, Ahmedabad</p>
                    </div>
                  </div>
		  <div class="col-md-4">
                    <div class="alert alert-dark text-center">
                        <h6><b>Dr Pankaj Goswami</b></h6>
                      <p>Assistant Professor AIIT, Lucknow, Vice-Chairman CSI LUCKNOW CHAPTER</p>
                    </div>
                  </div>
		  <div class="col-md-4">
                    <div class="alert alert-dark text-center">
		...
		<div class="col-md-4">
                    <div class="alert alert-dark text-center">
                        <h6><b>Dr. Ankit Vidyarthi</b></h6>
                      <p>Department of Computer Science & Engineering and Information Technology,
Jaypee Institute of Information Technology University, Noida</p>
                    </div>
                  </div>
		  <div class="col-md-4">
                    <div class="alert alert-dark text-center">
                        <h6><b>Jai Prakash V. Verma</b></h6>
                      <p>PhD, Associate Professor, Computer Science & Engineering Department, Institute Of Technology, Nirma University, Ahmedabad</p>
                    </div>
                  </div>
		   <div class="col-md-4">
                    <div class="alert alert-dark text-center">
 		...
 		<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Poonam Tandon</b></h6>
                        <p>Professor, Lucknow University, Lucknow</p>
                    </div>
                  </div>
 		<div class="col-md-4 text-center">
                    <div class="alert alert-dark">
		 ...
		 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Harish K. Dwivedi</b></h6>
                        <p>Professor & Dean-CRC Maharishi University of Information Technology, Lucknow</p>
                    </div>
                  </div>
 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Praveen Shukla</b></h6>
                        <p>Prof and Head Dept of IT BBD NIIT Lucknow</p>
                    </div>
                  </div>
 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Nitin A. Srivastava</b></h6>
                        <p>Assistant Professor, IET Lucknow</p>
                    </div>
                  </div>
 <div class="col-md-4 text-center">
                    <div class="alert alert-dark">
                        <h6><b>Dr. Preeta Sharan</b></h6>
                        <p>Professor The Oxford College of Engineering, Bangalore</p>
                    </div>
                  </div>
		<div class="col-md-4">
                    <div class="alert alert-dark text-center">
                        <h6><b>Dr. Manish Mishra</b></h6>
  ...
  <div class="row">
    <div class="column">
      <div class="map mb-4 mb-lg-0">
                ...
                <p class="text-center" style="color: #004289;font-family:Open Sans, sans-serif;">Amity School of Engineering and Technology,<br>
